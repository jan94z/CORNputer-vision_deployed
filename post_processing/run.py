...
from post_processing.scripts.size_analysis import SizeEstimator
from post_processing.scripts.yolo import *
...
def main(config, data, name, whatrun):
    ...
    if whatrun == "1":
        ...
        start = time.time()
        # tracking(cfg, data, name)
        single_seed_masks = data / "tracking" / name / "single_seed_masks"
